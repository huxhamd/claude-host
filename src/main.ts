...
import { ClaudeHostSettings, DEFAULT_SETTINGS } from './settings';
import { ClaudeHostSettingTab } from './settings-tab';
...
export default class ClaudeHostPlugin extends Plugin {
	...
	async onload(): Promise<void> {
		...
		this.registerView(
			VIEW_TYPE_CLAUDE,
			(leaf: WorkspaceLeaf) => new ClaudeTerminalView(
				leaf,
		...
		this.addSettingTab(new ClaudeHostSettingTab(this.app, this));
